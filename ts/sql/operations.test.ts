...
import { OperationTransformOptions, TransformedSqlOperation, transformOperationTemplate } from "./operations";

function test(
  params: Partial<OperationTransformOptions> & {
    operation: StorageOperation;
    expected: { sqlAst: SqlAst; sqlString: string; placeholders?: TransformedSqlOperation["placeholders"] };
  }
) {
        ...
        sqlAst: [
          {
            insert: {
              ...
              values: {
                fieldStr: { placeholder: { position: 1, name: "something" } },
                fieldInt: { literal: 5 },
    ...
    test({
      ...
      expected: {
        sqlAst: [
          {
            select: {
              source: { tableName: { identifier: "myCollection" } },
              fields: [{ source: { fieldName: { wildcard: true } } }],
              where: {
                eq: [
                  { source: { fieldName: { identifier: "fieldInt" } } },
                  { placeholder: { position: 1, name: "value" } },
                ],
              },
            },
          },
                ...
                and: [
                  {
                    eq: [
                      { source: { fieldName: { identifier: "fieldInt" } } },
                      { placeholder: { position: 1, name: "int" } },
                    ],
                  },
                  {
                    eq: [
                      { source: { fieldName: { identifier: "fieldStr" } } },
                      { placeholder: { position: 2, name: "str" } },
                    ],
                  },
                  { eq: [{ source: { fieldName: { identifier: "fieldBool" } } }, { literal: false }] },
                ],
              },
            },
          },
    ...
    test({
      ...
      operation: {
        ...
        relations: [
          ...
          { alias: "roleAttrib", relation: "attribute", where: { key: { $eq: "role" } } },
          { alias: "depAttrib", relation: "attribute", where: { key: { $eq: "department" } } },
        ...
        sqlAst: [
          {
            select: {
              ...
              fields: [
                ...
                {
                  source: {
                    alias: { identifier: "user_displayName" },
                    tableName: { identifier: "user" },
                    fieldName: { identifier: "displayName" },
                  },
                },
                {
                  source: {
                ...
                {
                  source: {
                    alias: { identifier: "roleAttrib_value" },
                    tableName: { identifier: "roleAttrib" },
                ...
                {
                  source: {
                    alias: { identifier: "depAttrib_value" },
                    tableName: { identifier: "depAttrib" },
                    fieldName: { identifier: "value" },
                  },
                },
              ...
              where: {
                and: [
                  {
                    eq: [
                      { source: { tableName: { identifier: "user" }, fieldName: { identifier: "id" } } },
                      { placeholder: { position: 1, name: "userId" } },
                    ],
                  },
                  {
                    eq: [
                      { source: { tableName: { identifier: "profile" }, fieldName: { identifier: "active" } } },
                      { literal: true },
                    ],
                  },
                ],
              ...
              joins: [
                {
                  ...
                  where: {
                    eq: [
                      { source: { tableName: { identifier: "email" }, fieldName: { identifier: "userId" } } },
                      { source: { tableName: { identifier: "user" }, fieldName: { identifier: "id" } } },
                    ],
                  },
                },
                {
                  ...
                  where: {
                    eq: [
                      { source: { tableName: { identifier: "emailKey" }, fieldName: { identifier: "emailId" } } },
                      { source: { tableName: { identifier: "email" }, fieldName: { identifier: "id" } } },
                    ],
                  },
                },
                {
                  ...
                  where: {
                    and: [
                      {
                        eq: [
                          { source: { tableName: { identifier: "roleAttrib" }, fieldName: { identifier: "userId" } } },
                          { source: { tableName: { identifier: "user" }, fieldName: { identifier: "id" } } },
                        ],
                      },
                      {
                        eq: [
                          { source: { tableName: { identifier: "roleAttrib" }, fieldName: { identifier: "key" } } },
                          { literal: "role" },
                        ],
                      },
                    ],
                ...
                },
                {
                  ...
                  where: {
                    and: [
                      {
                        eq: [
                          { source: { tableName: { identifier: "depAttrib" }, fieldName: { identifier: "userId" } } },
                          { source: { tableName: { identifier: "user" }, fieldName: { identifier: "id" } } },
                        ],
                      },
                      {
                        eq: [
                          { source: { tableName: { identifier: "depAttrib" }, fieldName: { identifier: "key" } } },
                          { literal: "department" },
                        ],
                      },
                    ],
                ...
                },
                {
                  ...
                  where: {
                    eq: [
                      { source: { tableName: { identifier: "profile" }, fieldName: { identifier: "userId" } } },
                      { source: { tableName: { identifier: "user" }, fieldName: { identifier: "id" } } },
                    ],
                  },
                },
  ...
  it("should transform an updateObjects operation", () => {
    test({
      operation: {
        ...
        updates: { fieldStr: "updated", fieldInt: { $placeholder: "newInt" } },
      },
      expected: {
        sqlAst: [
          {
            update: {
              ...
              where: {
                eq: [
                  { source: { fieldName: { identifier: "fieldInt" } } },
                  { placeholder: { position: 1, name: "oldInt" } },
                ],
              },
              updates: {
                fieldStr: { literal: "updated" },
                fieldInt: { placeholder: { position: 2, name: "newInt" } },
              },
            },
          },
        ],
