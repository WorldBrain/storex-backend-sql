...
export type SqlStatement = SqlInsertNode | SqlSelectNode | SqlUpdateNode | SqlDeleteNode | SqlCreateTableNode;
...
export type SqlLessEqualNode = SqlBinaryOp<"le">;
export type SqlGreaterThanNode = SqlBinaryOp<"gt">;
export type SqlGreaterEqualNode = SqlBinaryOp<"ge">;
...
export type SqlBinaryOp<Key extends string> = {
  [key in Key]: [SqlSourceNode, SqlSourceNode | SqlValueNode | SqlPlaceholderNode];
};
